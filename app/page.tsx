...
import HandAnalysisWorkspace from "../components/HandAnalysisWorkspace";
...
export default function Home(){
  ...
  {module==="hands"&&<HandAnalysisWorkspace onBack={()=>setModule("home")}/>} 
