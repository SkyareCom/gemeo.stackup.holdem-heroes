...
function opportunityForSpot(spot:TrainingSpot):PokerDecision["opportunity"]{
  const raw=spot.actionOpportunity;
  if(raw==="vpip"||raw==="pfr"||raw==="3bet"||raw==="blind-defense"||raw==="bluff-catch"||raw==="value"||raw==="bluff")return raw;
  return undefined;
}
