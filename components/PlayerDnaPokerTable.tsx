    ...
    root.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .plate{display:inline-flex;align-items:center;justify-content:center;min-width:70px;min-height:34px;padding:5px 9px;border-radius:8px;background:linear-gradient(#36322d,#11110f);border:2px solid #766650;box-shadow:0 4px 9px rgba(0,0,0,.7);white-space:nowrap}.plate b{font-size:15px;line-height:1;font-weight:800}
        ...
        .dealer{position:absolute;right:25%;bottom:17%;width:31px;height:31px;border-radius:50%;display:grid;place-items:center;background:#efefe9;color:#202020;border:2px solid #a8a8a2;font-size:9px;font-weight:800;box-shadow:0 2px 5px rgba(0,0,0,.45);z-index:6}
        ...
        @media(max-width:390px){.scene{width:100%;}.seat{width:78px}.plate{min-width:62px;min-height:32px}.plate b{font-size:13px}.backs span{width:25px;height:36px}.board .card{width:38px;height:53px}.suit{font-size:24px}.deck{width:44px;height:59px}}
      </style>
      <div class="scene">
