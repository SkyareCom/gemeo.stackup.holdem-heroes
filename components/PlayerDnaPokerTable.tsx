    ...
    root.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}
        ...
        @media(max-width:390px){.seat{width:54px}.plate{min-width:43px;min-height:21px;padding:3px 4px}.plate b{font-size:8px}.backs{height:31px}.backs span{width:19px;height:28px}.board .card{width:35px;height:49px}.suit{font-size:21px}}
      </style>
      <div class="scene">
