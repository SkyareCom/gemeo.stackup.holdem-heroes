    ...
    root.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .seat{position:absolute;width:82px;text-align:center;z-index:8;transform:translate(-50%,-50%);transition:filter .2s,transform .2s}.seat.active{filter:brightness(1.14);transform:translate(-50%,-50%) scale(1.035)}
        .s-mp{left:50%;top:7.7%}.s-mp2{left:78.5%;top:12.5%}.s-hj{left:94.5%;top:28.5%}.s-co{left:95%;top:57%}.s-btn{left:80.5%;top:84.5%}.s-sb{left:19.5%;top:84.5%}.s-bb{left:5%;top:57%}.s-utg{left:5.5%;top:28.5%}.s-utg1{left:21.5%;top:12.5%}
        ...
        .plate{display:inline-flex;align-items:center;justify-content:center;min-width:66px;min-height:32px;padding:5px 9px;border-radius:8px;background:linear-gradient(#39342f,#141311 56%,#090909);border:2px solid #796852;box-shadow:0 4px 9px rgba(0,0,0,.7),inset 0 1px 0 rgba(255,255,255,.08);white-space:nowrap}.plate b{font-size:14px;line-height:1;font-weight:900;letter-spacing:.2px}
        ...
        .dealer{position:absolute;right:25%;bottom:17.2%;width:31px;height:31px;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 35% 30%,#fff,#d9d9d4 65%,#b4b4af);color:#1f1f1f;border:2px solid #a7a7a2;font-size:9px;font-weight:900;box-shadow:0 2px 5px rgba(0,0,0,.45);z-index:6}
        ...
        @media(max-width:390px){.scene{width:100%}.seat{width:76px}.plate{min-width:60px;min-height:30px;padding:4px 7px}.plate b{font-size:12px}.backs span{width:24px;height:35px}.board .card{width:37px;height:52px}.suit{font-size:23px}.deck{width:43px;height:58px}.streetTrail{right:18.5%}}
      </style>
      <div class="scene">
