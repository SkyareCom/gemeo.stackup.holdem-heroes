    ...
    root.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .deck{position:absolute;right:15%;top:50.8%;width:42px;height:57px;border:2px solid #080808;border-radius:4px;background:linear-gradient(#202224,#111214);box-shadow:0 4px 9px rgba(0,0,0,.55);z-index:5}.deck:before{content:"";position:absolute;left:6px;right:6px;top:6px;height:34px;border:1px solid #eee;background:repeating-linear-gradient(45deg,#68809a 0 2px,#c6d0da 2px 4px)}
        ...
        .herostack{position:absolute;left:50%;bottom:10.5%;transform:translateX(-50%);font-size:13px;font-weight:900;text-shadow:0 2px 4px #000;z-index:7}
        ...
        .action{position:absolute;left:50%;top:59px;transform:translateX(-50%);background:#edf0eb;color:#173324;border-radius:999px;padding:2px 5px;font-size:6px;font-weight:900;box-shadow:0 2px 4px rgba(0,0,0,.35)}
        @media(max-width:390px){.seat{width:54px}.plate{min-width:43px;min-height:21px;padding:3px 4px}.plate b{font-size:8px}.backs{height:31px}.backs span{width:19px;height:28px}.board .card{width:35px;height:49px}.suit{font-size:21px}.deck{width:38px;height:52px}}
      </style>
      <div class="scene">
        <div class="table"><div class="felt">
          ...
          <div class="street">FLOP</div><div class="deck"></div><div class="dealer">D</div>
          <div class="herostack">$250</div>
